  ...
  <div class="flex min-h-screen">
    ...
    <div class="flex w-full flex-row">
      ...
      >
        ...
        <!-- Login box -->
        <div class="flex max-w-md flex-1 flex-col justify-center space-y-5">
        ...
        <!-- Footer -->
        <div
          class="m-auto mb-16 flex flex-col justify-center text-center text-lg dark:text-slate-200"
        >
          ...
          <div
            class="mt-4 flex flex-wrap items-center justify-center space-x-2"
          >
            <a
              href="https://www.linkedin.com/in/frankuxui/"
              class="flex h-12 w-12 flex-none items-center justify-center rounded-full transition-all hover:bg-slate-200 dark:hover:bg-slate-700"
              ><svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
