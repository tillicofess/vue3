<template>
    <div class="flex min-h-screen lg:mr-96">
        <div class="flex-1 bg-[#FBF9F6]">
            <content />
        </div>
        <div class="hidden lg:w-96 lg:h-screen fixed top-0 right-0 bg-[#22D48A] lg:flex justify-center items-center">
            <div class="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 dark:text-gray-100">
                <div class="text-center">
                    <h2 class="text-xl font-semibold">Dubai</h2>
                    <p class="text-sm dark:text-gray-400">July 29</p>
                </div>
